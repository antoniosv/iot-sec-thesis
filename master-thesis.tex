...
% Package to include author's name in references
...
Additionally, the works by \citet{DAC3323}, \citet{Zhang:2015}, and \citet{ALABA201710} briefly mention threats corresponding to specific IoT applications. These threats are:
...
% BibTeX bibliography
\bibliographystyle{plainnat}%alpha} %plain=[1], alpha=[BGZ09]
