...
The core of the security analysis in openHAB2 is how the data is being sent between devices, the openHAB2 instance, and the external web service. There are two ways in which the smart devices make their information available. .... local and through external apis...

\TODO talk about https

\TODO talk about security of a binding is for that thing only
